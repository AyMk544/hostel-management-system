...
import { mysqlTable, varchar, int, timestamp, text, boolean, mysqlEnum, decimal, date } from 'drizzle-orm/mysql-core';
...
export const queries = mysqlTable('queries', {
  ...
  status: mysqlEnum('status', ['pending', 'in_progress', 'resolved']).notNull().default('pending'),
